class DrawableTexture extends Drawable {
    ...
    draw() {
        ...
        const offset = 0;
        gl.bindBuffer(gl.ARRAY_BUFFER, this.textureCoordBuffer);
        gl.vertexAttribPointer(texturesCoordinationAttributeLocation, num, type, normalize, stride, offset);
        gl.enableVertexAttribArray(texturesCoordinationAttributeLocation);
